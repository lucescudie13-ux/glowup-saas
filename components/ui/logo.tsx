  ...
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>
        ...
        {/* Steel sheen across the bird, top-lit (coords in the icon’s 512 space). */}
        <linearGradient id={sid} x1="256" y1="40" x2="256" y2="480" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#e2fdff" />
          <stop offset="0.45" stopColor="#28e9ff" />
          <stop offset="1" stopColor="#0a86e6" />
        </linearGradient>
      </defs>
      <rect x="5" y="5" width="54" height="54" rx="16" fill="#0a111c" stroke={`url(#${gid})`} strokeWidth="3" />
      {/* Firebird — spread wings rising, scaled from 512 into the 64 badge. */}
      <g transform="translate(9.3 9.6) scale(0.0888)" fill={`url(#${sid})`}>
        <path d={PHOENIX_PATH} />
      </g>
    </svg>
  );
